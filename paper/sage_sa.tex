...
The French 66 percent credit raises equilibrium participation from 37.1 to 99.7 percent at a fiscal cost of 12.7 percent of mean labour income, below the work subsidy's one fifth and with the sign reversed. Gift Aid's 25 percent rebate, at a fiscal cost of just 4.1 percent of mean income, already lifts participation to 83.3 percent. The mechanism is the social feedback running in the desirable direction: each induced entry raises the participation rate, which raises every other household's belonging return, which induces further entries. The same complementarity that amplified the work subsidy's eight-point direct effect into a twenty-nine-point collapse turns a modest direct rebate into a participation boom. Implementing the rebate inside the budget constraint, rather than as a multiplier on the social payoff, if anything strengthens the effect, because the rebate also relaxes the participant's consumption and the income effect reinforces the social one.
