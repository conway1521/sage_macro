...
The discipline is the point. Risk aversion is set to the meta-analytic consensus on intertemporal substitution \citep{havranek2015}, the labour-supply elasticity to the quasi-experimental consensus \citep{chetty2011}, the discount factor and interest rate to standard annual values consistent with a stationary wealth distribution, and the effort-disutility scale is calibrated so that the baseline work share of committed time matches the French time-use figure of 0.53. Nothing else is tuned. The model then matches a hand-to-mouth share of 0.31, measuring as \citet{kaplan2014} do the households holding less than four weeks of income in wealth, and a wealth Gini of 0.55 against a French target of roughly 0.68 \citep{conway2025atlas}, neither of which it was aimed at.
...
Two untargeted moments then come out close to data: the hand-to-mouth share, households holding less than four weeks of income in wealth as in \citet{kaplan2014}, is 0.31, and the wealth Gini is 0.55, against roughly 0.68 in French data \citep{conway2025atlas} and roughly 0.38 in standard calibrations of this model class. The income Gini is understated at these two income states; separating education from income risk and adding a transitory component raises it to 0.27 to 0.33 in prototype runs, at the known one-asset cost that the hand-to-mouth share falls, the frontier that motivates the two-asset extension of \citet{kaplan2014}.
